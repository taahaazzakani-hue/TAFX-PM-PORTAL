...
export const STRIPE_PLANS = {
  ...
  private:  { id: 'price_1UJTnmPa6N6QL2tDuzug9XNP', name: 'Private Mentorship', price: 'R849',   period: 'per month' },
  oneonone: { id: 'price_1UJToZPa6N6QL2tDLdbHHcBI', name: '1-to-1 Mentorship',  price: 'R1 999', period: 'per month' },
};
